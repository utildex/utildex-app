export default {
  ...
  LABEL_DATE: 'Fecha',
  LABEL_TIME: 'Hora',
  LABEL_SOURCE_ZONE: 'Zona origen',
  LABEL_TARGET_ZONES: 'Zonas destino',
  LABEL_ADD_ZONE: 'Añadir una zona',
  LABEL_NOW: 'Ahora',
  LABEL_DETECT: 'Mi zona',
  LABEL_SWAP_WITH_SOURCE: 'Establecer como origen',
  LABEL_REMOVE: 'Quitar',
  ...
  RESULT_INVALID: 'Introduce una fecha, hora y zona origen válidas.',
  RESULT_SOURCE: 'Origen',
