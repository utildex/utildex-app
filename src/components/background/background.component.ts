...
@Component({
  ...
  template: `
    <div class="fixed inset-0 overflow-hidden" style="z-index: -50;">
        ...
        <!-- Deep Space Base -->
        <div class="absolute inset-0 bg-slate-50 dark:bg-[#020617] transition-colors duration-700">
             <!-- Subtle Dark Gradient Mesh -->
             <div class="absolute inset-0 opacity-0 dark:opacity-100 transition-opacity duration-700
                         bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-900 via-[#0f172a] to-black"></div>
             <div class="absolute inset-0 opacity-0 dark:opacity-40 transition-opacity duration-700
                         bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-indigo-950/30 via-transparent to-transparent"></div>
             ...
             <div class="absolute inset-0 opacity-100 dark:opacity-0 transition-opacity duration-700
                         bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-indigo-50 via-slate-50 to-white"></div>
        </div>

        <!-- Animated Colorful Stars (Light Mode) -->
        <div class="stars-container opacity-100 dark:opacity-0 transition-opacity duration-700 mix-blend-multiply">
        ...
        <div class="stars-container opacity-0 dark:opacity-100 transition-opacity duration-700">
  ...
  styles: [`
    ...
    .stars-sm { width: 1px; height: 1px; animation: star-anim 50s linear infinite; }
    .stars-md { width: 2px; height: 2px; animation: star-anim 75s linear infinite; }
    .stars-lg { width: 3px; height: 3px; animation: star-anim 100s linear infinite; }
...
export class BackgroundComponent {
    ...
    starsColorSmall = this.generateColorStars(500, ['#2563eb', '#7c3aed', '#db2777', '#059669', '#d97706']);
    starsColorMedium = this.generateColorStars(200, ['#1d4ed8', '#6d28d9', '#be185d', '#047857', '#b45309']);
    starsColorLarge = this.generateColorStars(80, ['#1e40af', '#5b21b6', '#9d174d', '#065f46', '#92400e']);
