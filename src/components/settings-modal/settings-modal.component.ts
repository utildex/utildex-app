              ...
              <section>
                ...
                <div class="grid grid-cols-2 gap-3">
                  @for (lang of languages; track lang.code) {
                    ...
                    >
                        <img [src]="'https://flagcdn.com/w40/' + lang.flagCode + '.png'" class="w-6 h-4 object-cover rounded shadow-sm">
              ...
              <section class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                    <button (click)="theme.isDark.set(false)" class="p-2 rounded-md transition-all flex items-center gap-2" [class.bg-white]="!theme.isDark()" [class.shadow-sm]="!theme.isDark()" [class.text-slate-900]="!theme.isDark()" [class.text-slate-500]="theme.isDark()">
                      <span class="material-symbols-outlined text-lg">light_mode</span>
                    </button>
                    <button (click)="theme.isDark.set(true)" class="p-2 rounded-md transition-all flex items-center gap-2" [class.bg-slate-700]="theme.isDark()" [class.shadow-sm]="theme.isDark()" [class.text-white]="theme.isDark()" [class.text-slate-500]="!theme.isDark()">
                ...
                <div>
                  ...
                  <div class="flex gap-2">
                    <button (click)="theme.setFont('inter')" [class]="getBtnClass(theme.fontFamily() === 'inter')">Inter (Sans)</button>
                    <button (click)="theme.setFont('system')" [class]="getBtnClass(theme.fontFamily() === 'system')">Merriweather (Serif)</button>
                    <button (click)="theme.setFont('roboto')" [class]="getBtnClass(theme.fontFamily() === 'roboto')">Mono</button>
                  </div>
                </div>
             ...
             <div class="animate-fade-in flex flex-col h-full">
               ...
               @if (inspectingCategory(); as catId) {
                  <div class="flex flex-col h-full">
                     <button (click)="inspectingCategory.set(null)" class="mb-4 flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-primary transition-colors">
