export const contractI18n = {
  en: {
    ...
    description:
      'Convert a date and time across IANA time zones with UTC offsets, day shifts and DST handled automatically. No data leaves your device. Works fully offline; feel free to disconnect.',
  },
  fr: {
