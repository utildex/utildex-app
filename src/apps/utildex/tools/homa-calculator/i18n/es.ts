export default {
  ...
  PROFILE_DEFAULTS_HINT_SHORT: 'Valores por defecto ÔÇö personaliza para mayor precision.',
  ...
  IR_SUMMARY_ELEVATED:
    'Tu resultado sugiere resistencia a la insulina elevada ÔÇö considera comentarlo con un profesional clinico.',
  IR_SUMMARY_HIGH:
    'Tu resultado sugiere una resistencia a la insulina alta ÔÇö recomendamos comentarlo con un profesional clinico.',
  ...
  QUICKI_SUMMARY_REDUCED:
    'Tu QUICKI sugiere sensibilidad reducida ÔÇö considera comentarlo con un profesional clinico.',
  ...
  REF_LEVY_1998:
    'Levy JC, Matthews DR, Hermans MP. Correct HOMA evaluation uses the computer program (HOMA2). Diabetes Care. 1998. ÔÇö Calculadora HOMA de Oxford OCDEM.',
  REF_KATZ_2000:
    'Katz A, Nambi SS, Mather K, et al. QUICKI ÔÇö Quantitative insulin sensitivity check index. J Clin Endocrinol Metab. 2000.',
  REF_MATLI_2021:
    'Matli B et al. Intervalos de referencia HOMA-IR en una poblacion alemana. CCLM. 2021.',
  REF_ICHIKAWA_2014:
    'Ichikawa T et al. Punto de corte japones para resistencia a la insulina (HOMA-IR ÔëÑ 1.7). Internal Medicine. 2014.',
  REF_KNHANES:
    'Estudio KNHANES (Corea) 2008ÔÇô2010 ÔÇö valores de referencia HOMA-IR en la poblacion coreana.',
  REF_EPIRCE:
    'Estudio EPIRCE (Espana) ÔÇö distribuciones de HOMA-IR por edad y sexo en la poblacion espanola.',
  ...
  METHOD_FORMULA_IR: 'HOMA-IR = insulina (┬ÁU/mL) ├ù glucosa (mmol/L) / 22.5',
  METHOD_FORMULA_B: 'HOMA-%B = 20 ├ù insulina / (glucosa mmol/L ÔêÆ 3.5)',
  METHOD_FORMULA_S: 'HOMA-%S = 100 / HOMA-IR',
  METHOD_FORMULA_QUICKI: 'QUICKI = 1 / (logÔéüÔéÇ(insulina) + logÔéüÔéÇ(glucosa mg/dL))',
  METHOD_LIMITATIONS:
