export const contractI18n = {
  en: {
    name: 'JWT Decoder',
    description:
      'Decode and inspect JSON Web Tokens (JWT) instantly, including header, payload, and time-based claims. No data leaves your device. Works fully offline; feel free to disconnect.',
    widgetPresets: {
      standard: 'Standard',
    },
  },
