export const contractI18n = {
  en: {
    ...
    description:
      'Create clean 2D line plots from JSON data with single-series, multi-series, and styled presets plus export options. No data leaves your device. Works fully offline; feel free to disconnect.',
  },
  fr: {
