export default {
  ...
  WHY_SEX:
    '在相同 BMI 下，女性的体脂百分比平均比男性高约 10 个百分点，公式已考虑此差异。',
  WHY_AGE:
    '在相同 BMI 下，体脂随年龄增长而上升、肌肉量下降，公式按年龄进行调整。',
  ...
  METHOD_FORMULA_CHILD:
    '儿童（7–15 岁）：体脂% = 1.51·BMI − 0.70·年龄 − 3.6·性别 + 1.4',
  METHOD_LIMITATIONS:
