export default {
  ...
  SUMMARY_OBESE: 'Your BAI is in the obese range ÔÇö consider discussing it with a clinician.',
  ...
  WHY_AGE:
    'BAI cutoffs are stratified by age band (20ÔÇô39, 40ÔÇô59, 60ÔÇô79). Below 18 cutoffs are not defined.',
  ...
  METHOD_FORMULA: 'BAI = hip (cm) / height (m)^1.5 ÔêÆ 18',
  METHOD_LIMITATIONS:
  ...
  REF_FREEDMAN_2012:
    'Freedman DS et al. The body adiposity index (hip circumference ├À height^1.5) is not a more accurate measure of adiposity than BMI, waist circumference, or hip circumference. Obesity. 2012.',
  REF_LOPEZ_2012:
    'L├│pez-Alvarenga JC et al. Body adiposity index: a critical reappraisal. Obesity. 2012.',
