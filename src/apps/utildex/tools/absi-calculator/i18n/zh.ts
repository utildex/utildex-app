export default {
  ...
  SUMMARY_VERYLOW:
    '您的 ABSI 远低于同性别同年龄段的平均水平——按此指标对应最低死亡风险。',
  SUMMARY_LOW:
    '您的 ABSI 低于同性别同年龄段的平均水平——对应较低的死亡风险。',
  SUMMARY_AVERAGE: '您的 ABSI 接近同性别同年龄段的人群平均水平。',
  SUMMARY_HIGH:
    '您的 ABSI 高于同性别同年龄段的平均水平——独立于 BMI，对应升高的死亡风险。',
  SUMMARY_VERYHIGH:
  ...
  NOTE_POPULATION:
    'ABSI 参考值源自美国（NHANES）成年人，在其他人群中表现可能不同。',
  ...
  WHY_AGE:
    'ABSI 通常随年龄上升。z 分数使用按年龄分十年的参考值，以将体型与年龄影响分离。',
  ...
  METHOD_FORMULA:
    'ABSI = 腰围(m) / (BMI^(2/3) · 身高(m)^(1/2))    其中 BMI = 体重(kg) / 身高(m)^2',
  METHOD_LIMITATIONS:
    '局限：ABSI 主要用于人群层面的死亡风险分层研究指标。不能替代临床评估，且本工具的参考数据源自 NHANES 成年人。对接近平均水平的个体分数请勿过度解读。',

  REFERENCES_HEADING: '参考文献',
  REF_KRAKAUER_2012:
    'Krakauer NY, Krakauer JC. A new body shape index predicts mortality hazard independently of body mass indexÒÇéPLoS ONE´╝î2012;7(7):e39504ÒÇé',
  REF_KRAKAUER_2014:
    'Krakauer NY, Krakauer JC. Dynamic association of mortality hazard with body shapeÒÇéPLoS ONE´╝î2014;9(2):e88793ÒÇé',
  REF_DHANA_2016:
