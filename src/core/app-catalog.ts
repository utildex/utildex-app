...
export const APP_CATALOG = {
  utildex: {
    ...
    source: {
      ...
      appComponentFile: 'src/apps/utildex/shell/app.component.ts',
      appComponentTemplateFile: 'src/apps/utildex/shell/app.component.html',
      routesFile: 'src/apps/utildex/routing/app.routes.ts',
      coreRegistryFile: 'src/apps/utildex/core-registry.ts',
      moduleRegistryFile: 'src/apps/utildex/module-registry.ts',
  ...
  synedex: {
    ...
    source: {
      ...
      appComponentFile: 'src/apps/synedex/shell/app.component.ts',
      appComponentTemplateFile: 'src/apps/synedex/shell/app.component.html',
      routesFile: 'src/apps/synedex/routing/app.routes.ts',
      coreRegistryFile: 'src/apps/synedex/core-registry.synedex.ts',
      moduleRegistryFile: 'src/apps/synedex/module-registry.ts',
  ...
  simudex: {
    ...
    source: {
      ...
      appComponentFile: 'src/apps/simudex/shell/app.component.ts',
      appComponentTemplateFile: 'src/apps/simudex/shell/app.component.html',
      routesFile: 'src/apps/simudex/routing/app.routes.ts',
      coreRegistryFile: 'src/apps/simudex/core-registry.simudex.ts',
      moduleRegistryFile: 'src/apps/simudex/module-registry.ts',
