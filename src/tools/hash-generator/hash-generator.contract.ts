...
export const contract: ToolContract = {
  ...
  metadata: {
    ...
    description: {
      ...
      fr: 'Calculez des hachages MD5, SHA-1, SHA-256, SHA-384, SHA-512 a partir de texte ou de fichiers. Fonctionne entierement hors ligne.',
      es: 'Calcula hashes MD5, SHA-1, SHA-256, SHA-384, SHA-512 desde texto o archivos. Funciona completamente sin conexion.',
