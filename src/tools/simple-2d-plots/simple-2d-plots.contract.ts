...
export const contract: ToolContract = {
  ...
  metadata: {
    ...
    description: {
      ...
      fr: 'Créez des graphiques 2D propres à partir de données JSON avec des presets série unique, multi-série et stylés, ainsi que des options d’export. Aucune donnée ne quitte votre appareil. Fonctionne entièrement hors ligne ; vous pouvez couper internet.',
