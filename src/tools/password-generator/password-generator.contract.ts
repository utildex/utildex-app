...
export const contract: ToolContract = {
  ...
  metadata: {
    ...
    description: {
      ...
      fr: 'Creez des mots de passe aleatoires et securises avec une longueur et des jeux de caracteres personnalisables. Aucune donnee ne quitte votre appareil. Fonctionne entièrement hors ligne; vous pouvez couper internet.',
