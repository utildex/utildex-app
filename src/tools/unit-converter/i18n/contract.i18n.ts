export const contractI18n = {
  en: {
    name: 'Unit Converter',
    description:
      'Convert between common units of length, weight, and temperature. No data leaves your device. Works fully offline; feel free to disconnect.',
  },
  fr: {
  ...
  zh: {
    name: '单位转换器',
    description: '在长度、重量和温度的常用单位之间进行转换。数据不会离开你的设备。完全离线运行；你可以断开网络。',
  },
} as const;
