...
- [Multi-App Restructuring Plan](multi-app/restructuring-plan.md)
- [Maintainer Scaffolding](multi-app/scaffolding.md)
...
- [Processing Loader](processing-loader/README.md)
...
| [Multi-App Restructuring Plan](multi-app/restructuring-plan.md) | The target app/module/platform model, compatibility rules, PR stack, and validation guardrails for the restructuring program.                                                                                     | You are reviewing or implementing the restructuring PRs, introducing module vocabulary, or deciding where a new boundary lives. |
| [Maintainer Scaffolding](multi-app/scaffolding.md)              | Repo-local CLI commands for dry-run/apply scaffolding of apps and modules, including options, planned outputs, and safety rules for humans and agents.                                                            | You are creating a new module or bootstrapping a new app variant.                                                               |
...
| [Simudex Platform](simudex/README.md)                           | Simudex app architecture: bundle boundary, routes, registries, sandbox contracts, shared terminal platform, plugin host, Debian runtime scaffold, worker bridge, preview shell, and CheerpX/WebVM runtime client. | You are implementing simulation sandboxes, extending terminal/runtime contracts, or adding Debian runtime assets.               |
...
| [Processing Loader](processing-loader/README.md)                | Visual cue component with rotating status messages and progress indication for long-running operations.                                                                                                           | You are adding a processing/loading state to a tool or debugging the loader behavior.                                           |
